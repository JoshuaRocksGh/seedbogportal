...
<!-- Mirrored from coderthemes.com/ubold/layouts/light/pages-logout.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 04 Mar 2019 09:53:38 GMT -->
<head>
        <meta charset="utf-8" />
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <a href="index.html">
                                        <span><img src="{{('assets/images/slcb_sm.png')}}" alt=""></span>
                                    </a>
                                </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p>Back to <a href="{{url('/login')}}" style="font-weight: bold;color: red"><b>Sign In</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
